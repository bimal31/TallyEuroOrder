...
function gridgetdata()
{
    ...
    $("#ContentPlaceHolder1_grdProductFree tr").each(function ()
    {
        ...
        if (rowtype == 'rows')
        {
            ...
            var Fromscheme = $(this).find("td:eq(1)").html()
            var Toscheme = $(this).find("td:eq(2)  span").html()
            var Totalkg = $(this).find("td:eq(3) span").html()
